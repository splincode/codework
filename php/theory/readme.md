...
<a href="#n4">1.4. Что такое TDD?</a><br>
<a href="#n5">1.5. В чем отличие типа DECIMAL от FLOAT в mysql и в каких случаях нужно использовать тот или иной тип данных? </a><br>
<a href="#n6">1.6. Что такое Singleton и в каких случаях его следует применять? </a><br>
<a href="#n7">1.7. Чем отличается абстрактный класс от интерфейса? </a><br>
<a href="#n8">1.8. Что означает запись $a = 'ololo'; $b = $$a;  </a><br>
<a href="#n9">1.9. Что такое adjacency tree? Какие есть альтернативы?   </a><br>
<a href="#n10">1.10. Для чего нужны индексы в базе данных и как они работают? </a><br>
<a href="#n11">1.11. Что означает запись $a = $b ?: $c; ? </a><br>
<a href="#n12">1.12. Какие виды атак возможны при заполнении формы для публикации в блог?  </a><br>
