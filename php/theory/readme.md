...
<a href="#n3">&nbsp;1.4. Что означает запись $a =& $b?</a><br>
<a href="#n4">&nbsp;1.5. Что такое TDD?</a><br>
<a href="#n5">&nbsp;1.6. В чем отличие типа DECIMAL от FLOAT в mysql и в каких случаях нужно использовать тот или иной тип данных? </a><br>
<a href="#n6">&nbsp;1.7. Что такое Singleton и в каких случаях его следует применять? </a><br>
<a href="#n7">&nbsp;1.8. Чем отличается абстрактный класс от интерфейса? </a><br>
<a href="#n8">&nbsp;1.9. Что означает запись $a = 'ololo'; $b = $$a;  </a><br>
<a href="#n9">&nbsp;1.10. Что такое adjacency tree? Какие есть альтернативы?   </a><br>
<a href="#n10">&nbsp;1.11. Для чего нужны индексы в базе данных и как они работают? </a><br>
<a href="#n11">&nbsp;1.12. Что означает запись $a = $b ?: $c; ? </a><br>
<a href="#n12">&nbsp;1.13. Какие виды атак возможны при заполнении формы для публикации в блог?  </a><br>
