...
/***/ function(module, exports, __webpack_require__) {
	...
	this.storage.structure.item.push(angular.copy(storageService.base));}/**
	     ...
	     * @return {[type]} [description]
	     */},{key:'appQuit',value:function appQuit(){window.app.quit();}},{key:'newProject',value:function newProject(){var storageService=this.storage;var startService=this._newProject;angular.extend(storageService,startService);}/**
	     * [pageProcess description]
	     * @return {[type]} [description]
	     */},{key:'pageProcess',value:function pageProcess(){var page=this.page;for(var i in page){page[i]=false;}page.process=true;}}]);return AppController;}();var AppComponent=exports.AppComponent={template:__webpack_require__(11),controller:['$rootScope','$scope','storageService',AppController]};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
/***/ function(module, exports) {
	...
	F:[],leftSealing:false,// заделка слева
