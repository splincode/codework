...
<p>Программа хорошо отрабатывает с числами до 1*10<sup>18</sup>. 
Очень долгие расчеты происходят на числах от 20 и более знаков (в связи с багом при вычислении квадратного корня). 
Программа написана в линейной реализации. Если написать алгоритм параллельных арифметических расчетов,
можно добиться более быстрого получения результата на больших числах.</p>
<b>Простые числа</b>
